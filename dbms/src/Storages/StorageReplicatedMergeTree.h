...
public:
    ...
    bool optimize(const ASTPtr & query, const ASTPtr & partition, bool final, bool deduplicate, const Settings & settings) override;

    void alter(const AlterCommands & params, const String & database_name, const String & table_name, const Context & context) override;

    void clearColumnInPartition(const ASTPtr & partition, const Field & column_name, const Settings & settings) override;
    void dropPartition(const ASTPtr & query, const ASTPtr & partition, bool detach, const Settings & settings) override;
    void attachPartition(const ASTPtr & partition, bool part, const Settings & settings) override;
    void fetchPartition(const ASTPtr & partition, const String & from, const Settings & settings) override;
    void freezePartition(const ASTPtr & partition, const String & with_name, const Settings & settings) override;
